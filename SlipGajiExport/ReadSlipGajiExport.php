...
class ReadSlipGajiExport extends Conn {
  public function GetSlipGajiExport () {
    ...
    $sth = $dbh->prepare("SELECT slip_gaji.nip, slip_gaji.nama, slip_gaji.tunjangan_jabatan, slip_gaji.tunjangan_suami_istri, slip_gaji.tunjangan_anak, slip_gaji.tanggal_slip, slip_gaji.total_gaji, slip_gaji.total_tunjangan, slip_gaji.total_potongan, potongan_lainlain.jenis AS nama_potongan_lainlain, potongan_lainlain.potongan AS potongan_lainlain, gaji_pokok.gaji AS gaji_pokok
