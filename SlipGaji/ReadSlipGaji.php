...
class ReadSlipGaji extends Conn {
  ...
  public function GetSlipGaji () {
    ...
    if ($nips !== 0) {
      ...
      if ($tahun !== 0 && $bulan !== 0) {
        $sth = $dbh->prepare("SELECT slip.id AS id, slip.nip AS nip, slip.nama AS nama, jenis.jenis AS jenis_slip, slip.jenis AS id_jenis_slip, slip.tunjangan_jabatan AS tunjangan_jabatan, slip.tunjangan_suami_istri AS tunjangan_suami_istri, slip.tunjangan_anak AS tunjangan_anak, slip.tunjangan_beras AS tunjangan_beras, slip.jkk AS jkk, slip.jkm AS jkm, slip.bpjs AS bpjs, slip.iwp_1_persen AS iwp_1_persen, slip.iwp_8_persen AS iwp_8_persen, gapok.golongan AS golongan, gapok.masa_kerja AS masa_kerja, gapok.gaji AS gaji_pokok, pot.id AS id_potongan, pot.nama AS nama_potongan, pot.jenis AS jenis_potongan, pot.potongan AS potongan, tun.id AS id_tunjangan, tun.nama AS nama_tunjangan, tun.jenis AS jenis_tunjangan, tun.tunjangan AS tunjangan, potl.jenis AS nama_potongan_lainlain, potl.potongan AS potongan_lainlain, slip.tanggal_slip AS tanggal_slip, slip.total_gaji AS penerimaan, slip.total_tunjangan AS total_tunjangan, slip.total_potongan AS total_potongan
